...
The application allows students to register, log in, take multiple-choice quizzes, receive quiz results, view their quiz history, and check their overall performance.
...
4. Attempt randomly selected questions.
5. Submit answers using A/B/C/D.
6. Receive the score after completing the quiz.
